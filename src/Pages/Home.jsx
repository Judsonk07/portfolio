...
const TECH_STACK = ["AWS", "Cloud", "Devops", "Flutter", "FireBase"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Judsonk07" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/judson-k/" },
  { icon: Instagram, link: "https://www.instagram.com/mr._.santa.__/" },
];
      ...
      >
        <div className="container mx-auto px-[5%] sm:px-6 lg:px-[0%] min-h-screen">
          <div className="flex flex-col lg:flex-row items-center justify-center h-screen md:justify-between gap-0 sm:gap-12 lg:gap-20">
            ...
            >
              <div className="space-y-4 sm:space-y-6">
                ...
                <p
                  ...
                  data-aos-delay="1000"
                >
                  Innovative Cloud Enthusiast and Software Developer Building
                  scalable, functional, and user-friendly applications powered
                  by modern cloud technologies.
                </p>
            ...
            <div
              className="w-full py-[10%] sm:py-0 lg:w-1/2 h-auto lg:h-[700px] xl:h-[850px] relative flex items-center justify-center order-2 lg:order-2 mt-8 lg:mt-0"
