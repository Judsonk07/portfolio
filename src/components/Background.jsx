		...
		<div className="fixed inset-0 ">
			<div className="absolute inset-0">
				...
				<div
					...
					// use less aggressive negative offset to avoid pushing content on wide viewports
					className="absolute -bottom-8 left-[-20%] md:left-20 w-96 h-96 bg-blue-500 rounded-full mix-blend-multiply filter blur-[128px] opacity-40 md:opacity-20 hidden sm:block"></div>
					<div
